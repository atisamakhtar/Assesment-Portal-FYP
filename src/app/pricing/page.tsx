...
export default function Pricing({}: Props) {
  return (
    ...
    <div className="justify-center w-full pt-12 pb-px bg-gradient-to-r from-gray-50 to-gray-100 dark:from-zinc-900 dark:to-zinc-800 ">
      <h1 className=" text-center font-bold text-3xl text-gray-800 mb-4">Unlock Your Potential with Our Courses</h1>
      <p className="text-center font-semibold text-base text-gray-600 mb-8">Choose the perfect plan for your learning journey</p>

      </div>

    <section className="min-h-screen w-full pb-1 bg-gradient-to-r from-gray-50 to-gray-100 dark:from-zinc-900 dark:to-zinc-800 flex items-center justify-center">
