...
export default function Pricing({ }: Props) {
  return (
    <div className=" dark:from-zinc-900 dark:to-zinc-800 bg-gradient-to-r from-gray-50 to-gray-100" >
      ...
      <section className="my-16 w-full pb-1 flex items-center justify-center">
