...
export default function Pricing({ }: Props) {
  return (
    <div className="py-16 dark:from-zinc-900 dark:to-zinc-800 bg-gradient-to-r from-gray-50 to-gray-100" >

      <div className="justify-center w-full pt-12 pb-px ">
      ...
      <section className="w-full pb-1 flex items-center justify-center">
